			...
			var inner = "";
   			...
   			if(result.list.length > 0)
   			{
   				for(var i = 0; i < result.list.length; i++)
   				{
   					...
   					inner += '	<ul><a href="/admin/users/adest_edit?idx='+result.list[i].idx+'"><li>';
					...
					inner += '	</li>';
   					...
   					inner += '	<li>'+result.list[i].contents+'</li>';
   					inner += '	<li>'+comma(result.list[i].pay)+'</li>';
   					inner += '	<li>'+comma(result.list[i].min_pay)+'</li>';
   					inner += '</a></ul>';
...
<div id="container" class="report">
	<div class="contain_inner">
    	<div class="search">
    		<p>광고견적 관리<span>광고견적 관리 리스트입니다.</span></p>
    		<input type="button" class="enroll" value="등록" onclick="location.href='/admin/users/adest_upload'"/>
    		<div class="seacrh_info search_bot select_a">
    			<table>
                    <tr>
                        ...
                        <td>
                            <div class="m_line">
                                   <select de-data="전체" id="search_type" class="dis-no d_inline" name="search_type" >
	                                    <option value="">전체</option>
	                                    <option value="cate1">대분류</option>
	                                    <option value="cate2">중분류</option>
	                                    <option value="contents">광고내용</option>
                                   </select>
                                <!-- <div class="d_inline">
                                    <ul class="check_wrap">
                                        <li>
        ...
        <div class="search_con_wrap">
            ...
            <div class="table-list text-center table-fix table-ad">
            <div>
                <div class="t_hd">
	                <ul>
	                  	<li><input class="regular-radio" type="checkbox" id="chk_all" name="chk_all" value="chk_val"/><label for="chk_all"></label></li>
	                    <li>대분류<span id="" onclick="reSortAjax('sort_cate1')"><img src="/img/list_icon_down.png" ></span></li>
	                    <li>중분류<span id="" onclick="reSortAjax('sort_cate2')"><img src="/img/list_icon_down.png"></span></li>
	                    <li>광고내용<span id="" onclick="reSortAjax('sort_contents')"><img src="/img/list_icon_down.png"></span></li>
	                    <li>단가<span id="" onclick="reSortAjax('sort_pay')"><img src="/img/list_icon_down.png"></span></li>
	                    <li>최소청약<span id="" onclick="reSortAjax('sort_min_pay')"><img src="/img/list_icon_down.png"></span></li>
	                </ul>
                </div>
                <div class="tb_div">
                </div>
