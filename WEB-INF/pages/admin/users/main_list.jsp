		...
		success : function(data) 
		{
			...
			if(result.list.length > 0)
			{
				for(var i = 0; i < result.list.length; i++)
				{
					...
					inner += '	<li class="res_name" onclick="javascript:location.href=\'./mainbanner_upload?idx='+result.list[i].idx+'\'">'+nullChk(result.list[i].main_title)+'</li>';
...
function setSort()
{
	for(var i = 0; i<document.getElementsByName('idxs').length; i++)
	{
		...
		$.ajax({
			...
			url : "/admin/setSort?tb=tbl_mbanner&sort="+i+"&idx="+idx,//호출 URL을 설정한다. GET방식일경우 뒤에 파라티터를 붙여서 사용해도된다.
...
function preview()
{
	...
	window.open("./preview_mbanner?idx="+chkList);
}
...
<div id="container" class="report">
	<div class="contain_inner">
    	<div class="search">
    		<p>메인배너 관리<span>배너관리 리스트입니다.</span></p>
    		<input type="button" class="enroll" value="등록" onclick="location.href='/admin/users/mainbanner_upload'"/>
                        ...
                        <td>
                            <div class="m_line">
                                ...
                                <select de-data="전체" id="search_type" name="search_type" class="dis-no d_inline">
                                    ...
                                    <option value="title">메인 타이틀</option>
        ...
        <div class="search_con_wrap">
            ...
            <div>
                ...
                <ul>
                    ...
                    <li>메인 타이틀<span onclick="reSortAjax('sort_main_title')"><img src="/img/list_icon_down.png" id="sort_main_title"/></span></li>
                    ...
                    <li>등록일<span onclick="reSortAjax('sort_tbl_mbanner.submit_date')"><img src="/img/list_icon_down.png" id="sort_tbl_mbanner.submit_date"/></span></li>
