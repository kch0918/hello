     		...
     		success : function(data) 
     		{
     			...
     			if(result.list.length > 0)
     			{
     				for(var i = 0; i < result.list.length; i++)
     				{
     					...
     					inner += '	<li class="res_name" onclick="javascript:location.href=\'./adquest_upload?idx='+result.list[i].idx+'\'">'+nullChk(result.list[i].title)+'</li>';
...
<div id="container" class="report">
	<div class="contain_inner">
    	<div class="search">
    		<p>광고문의 관리<span>문의 내역 리스트입니다.</span></p>
