...
function setSort()
{
	for(var i = 0; i<document.getElementsByName('idxs').length; i++)
	{
		...
		$.ajax({
			...
			url : "/admin/setSort?tb=tbl_sbanner&sort="+i+"&idx="+idx,//호출 URL을 설정한다. GET방식일경우 뒤에 파라티터를 붙여서 사용해도된다.
...
<div id="container" class="report">
	<div class="contain_inner">
    	<div class="search">
    		<p>중간배너 관리<span>배너관리 리스트입니다.</span></p>
    		<input type="button" class="enroll" value="등록" onclick="location.href='/admin/users/subbanner_upload'"/>
                            ...
                            <div class="m_line">
                                ...
                                <div class="check_box">
                                    <ul class="check_wrap check_d">
                                        <li onclick="setDateBySearch('all');"><input type="radio" id="allChk" name="during" value="" class="regular-radio"/><label for="allChk"><span>전체</span></label></li>
                                        ...
                                        <li onclick="setDateBySearch('1');"><input type="radio" id="radio-1-4" name="during" value="" class="regular-radio" checked/><label for="radio-1-4"><span>1개월</span></label></li>
        ...
        <div class="search_con_wrap">
            ...
            <div>
                ...
                <ul>
                    ...
                    <li>배너명<span onclick="reSortAjax('sort_main_title')"><img src="/img/list_icon_down.png" id="sort_main_title"/></span></li>
                    ...
                    <li>등록일<span onclick="reSortAjax('sort_tbl_sbanner.submit_date')"><img src="/img/list_icon_down.png" id="sort_tbl_sbanner.submit_date"/></span></li>
