     		...
     		success : function(data) 
     		{
     			...
     			if(result.list.length > 0)
     			{
     				for(var i = 0; i < result.list.length; i++)
     				{
     					...
     					inner += '	<li class="res_name" onclick="javascript:location.href=\'./request_upload?idx='+result.list[i].idx+'\'">'+nullChk(repName(result.list[i].name))+'</li>';
     					inner += '	<li>'+nullChk(repTel(result.list[i].tel))+'</li>';
     					inner += '	<li>'+nullChk(repEmail(result.list[i].email))+'</li>';
     					inner += '	<li>'+nullChk(result.list[i].hope_name)+'</li>';
...
<div id="container" class="report">
	<div class="contain_inner">
    	<div class="search">
    		<p>견적 신청 리스트<span>견적 진행한 리스트입니다.</span></p>
    		<input type="button" class="enroll dis-no" value="등록" onclick="location.href='/admin/users/request_upload'"/>
        ...
        <div class="search_con_wrap">
            ...
            <div class="table-list text-center table-fix table-qoutap">
            <div>
                <div class="t_hd">
                <ul>
                    <li><input class="regular-radio" type="checkbox" id="chk_all" name="chk_all" value="chk_val"/><label for="chk_all"></label></li>
                    <li>NO.<span onclick="reSortAjax('sort_tbl_request.idx')"><img src="/img/list_icon_down.png" id="sort_tbl_request.idx"/></span></li>
                    <li>성함.<span onclick="reSortAjax('sort_name')"><img src="/img/list_icon_down.png" id="sort_name"/></span></li>
                    <li>연락처.<span onclick="reSortAjax('sort_tel')"><img src="/img/list_icon_down.png" id="sort_tel"/></span></li>
                    <li>이메일.<span onclick="reSortAjax('sort_email')"><img src="/img/list_icon_down.png" id="sort_email"/></span></li>
                    <li>선호 광고 매체<span onclick="reSortAjax('sort_hope_item')"><img src="/img/list_icon_down.png" id="sort_hope_item"/></span></li>
                    <li>선택 동의 여부<span id="" onclick=""><img src="/img/list_icon_down.png" id="sort_submit_date"/></span></li>
                    <li>작성일<span onclick="reSortAjax('sort_submit_date')"><img src="/img/list_icon_down.png" id="sort_submit_date"/></span></li>
                    <li>진행상태<span onclick="reSortAjax('sort_condition')"><img src="/img/list_icon_down.png" id="sort_condition"/></span></li>
                </ul>
                </div>
                <div class="tb_div">
              </div>
