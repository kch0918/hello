		...
		success : function(data) 
		{
			...
			if(result.list.length > 0)
			{
				for(var i = 0; i < result.list.length; i++)
				{
					...
					inner += '	<li class="res_name" onclick="javascript:location.href=\'./portfolio_upload?idx='+result.list[i].idx+'\'">'+nullChk(result.list[i].main_title)+'</li>';
					inner += '	<li>'+nullChk(result.list[i].cate)+'</li>';
					inner += '	<li><img src="/upload/port/'+result.list[i].banner+'" alt="" style="width:57px; height:45px;"></li>';
...
function setSort()
{
	for(var i = 0; i<document.getElementsByName('idxs').length; i++)
	{
		...
		$.ajax({
			...
			url : "/admin/setSort?tb=tbl_port&sort="+i+"&idx="+idx,//호출 URL을 설정한다. GET방식일경우 뒤에 파라티터를 붙여서 사용해도된다.
...
<div id="container" class="report">
	<div class="contain_inner">
    	<div class="search">
    		<p>포트폴리오 관리<span>포트폴리오 관리 리스트입니다.</span></p>
    		<input type="button" class="enroll" value="등록" onclick="location.href='/admin/users/portfolio_upload'"/>
        ...
        <div class="search_con_wrap">
            ...
            <div>
                ...
                <ul>
                    ...
                    <li>NO.<span onclick="reSortAjax('sort_tbl_port.idx')"><img src="/img/list_icon_down.png" id="sort_tbl_port.idx"/></span></li>
                    <li>제목<span onclick="reSortAjax('sort_main_title')"><img src="/img/list_icon_down.png" id="sort_main_title"/></span></li>
                    <li>분류<span onclick="reSortAjax('sort_cate')"><img src="/img/list_icon_down.png" id="sort_cate"/></span></li>
                    <li>노출 이미지<span onclick="reSortAjax('sort_banner')"><img src="/img/list_icon_down.png" id="sort_banner"/></span></li>
                    <li>등록일<span onclick="reSortAjax('sort_tbl_port.submit_date')"><img src="/img/list_icon_down.png" id="sort_tbl_port.submit_date"/></span></li>
