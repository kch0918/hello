		...
		success : function(data) 
		{
			...
			if(result.list.length > 0)
			{
				for(var i = 0; i < result.list.length; i++)
				{
					...
					inner += ' 		<a href="/info_view?idx='+result.list[i].idx+'">';
...
<div id="board-sec01">
	<div class="board_tab">
		...
		<ul>
			...
			<li class="on"><a href="./info">이용안내</a></li>
		</ul>
	</div>
	...
	<div class="notice-list-header">
		...
		<div class="board-search">
				<input type="text" name="searchName"  id="searchName" value="" placeholder="검색어를 입력해주세요." onkeypress="javascript:pagingReset(); excuteEnter(getList);"/>
