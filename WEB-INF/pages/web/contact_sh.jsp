...
<div id="contact-sec01" class="sh_myshop_wrap">
<div class="contact_wr">
	<img src="/img/web/img/shmyshop_logo.png" class="shmyshop_logo" alt="shmyshop_logo">
	<h3 class="bd_tit">광고 문의</h3>
	<p class="sub_tit4 online_tit lg-txt">(신한카드 마이샵파트너 회원 전용)</p>
	<div class="sh_infoTxt online_stit ">
		<p class="c-red">이  페이지는 마이샵파트너에 가입하신 대표님들만 <span class="break"></span>이용 가능합니다.<br><span class="break"></span></p>
		대표자님 이름과 연락처 및 궁금하신 광고 매체 등을<span class="break"></span> 입력해주시면<br>
		LG헬로비전 담당자가 평일 24시간 이내로 연락 드리겠습니다.<br><span class="break"></span>
		<br><span class="break"></span>
		<em>* 문의사항은 LG헬로비전 고객센터(1855-0909)로 문의해주세요.</em>
		
	</div>
	<form id="fncForm" name="fncForm" method="post" action="/contact_proc_sh" enctype="multipart/form-data">
		<div class="form_wr">
			<div class="row two">
				<div class="key_name">
					<div class="key">
